package com.apu.apstay.resident.controllers.profile;
 ...
 * @author alexc
 */
@WebServlet(name = "ResidentProfileHomeServlet", urlPatterns = {"/resident/profile"})
public class HomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/resident/profile/index.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/resident/profile");

...
<resident:layout title="My Profile">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form id="accountForm" method="POST" action="${pageContext.request.contextPath}/resident/profile">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 text-right">
                                    <a href="${pageContext.request.contextPath}/resident/profile/change-password" class="btn btn-warning">
            ...
            <div class="col-lg-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form id="personalForm" method="POST" action="${pageContext.request.contextPath}/resident/profile">
